...
train_dataloader = dict(dataset=dict(ann_file='train_EvalProtocol_TRAIN_TEST.txt'))
test_dataloader = dict(dataset=dict(ann_file='test_EvalProtocol_TRAIN_TEST.txt'))
