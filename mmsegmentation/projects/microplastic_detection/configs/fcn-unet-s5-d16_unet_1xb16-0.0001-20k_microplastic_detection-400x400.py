...
model = dict(
    ...
    auxiliary_head=None,
    test_cfg=dict(mode='slide', crop_size=crop_size, stride=(300, 300)),
    #test_cfg=dict(mode='whole'),
    )

# runtime config overrides
load_from = "/home/taiamiti/Projects/mmsegmentation/work_dirs/fcn-unet-s5-d16_unet_1xb16-0.0001-20k_microplastic_detection-256x256/best_mIoU_iter_3600.pth" # None  # todo add pretrained model
